...
#     try:
#         print(f"\nReceived new audio file upload: {audio_file.filename}")
...
#         print(f"Temporary M4A file saved: {temp_m4a.name}")
#         print(f"File size: {os.path.getsize(temp_m4a.name)} bytes")
...
#         print(f"  - Should Notify: {confidence > 0.97}")
...
#     except Exception as e:
#         log_with_print(f"Error processing audio file: {str(e)}")
#         return {"status": "error", "error": str(e)}
